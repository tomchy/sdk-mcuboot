...
#define FIXED_PARTITION_ADDR(node_label)                                     \
    (COND_CODE_0(DT_FIXED_PARTITION_EXISTS(DT_NODELABEL(node_label)),        \
        (DT_REG_ADDR(DT_NODELABEL(node_label))),                             \
        (COND_CODE_1(DT_FIXED_SUBPARTITION_EXISTS(DT_NODELABEL(node_label)), \
            (DT_FIXED_SUBPARTITION_ADDR(DT_NODELABEL(node_label))),          \
            (DT_FIXED_PARTITION_ADDR(DT_NODELABEL(node_label)))))))
